...
#menuData = ['디카페인 아메리카노', 'TEST DESCRIPTION', 'img\\drink1\\HOT_디카페인 아메리카노.jpg', 2500]
#optionData = ['AddDeShot', 'AddStevia']
class aiOptionWindow(QDialog, form_class) :
    ...
    def __init__(self, menuData, optionData, parent) :
        ...
        self.originPrice = menuData[3]
        self.totalPrice = menuData[3]
